...
struct Z_Construct_UClass_UDataLogger_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UDataLogger_StartLogging, "StartLogging" }, // 522275214
		{ &Z_Construct_UFunction_UDataLogger_StopLogging, "StopLogging" }, // 2141979894
	};
...
struct Z_CompiledInDeferFile_FID_unreal_project_LODPlugin_Plugins_MLBasedLODSelector_Source_MLBasedLODSelector_Public_DataLogger_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDataLogger, UDataLogger::StaticClass, TEXT("UDataLogger"), &Z_Registration_Info_UClass_UDataLogger, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataLogger), 444749859U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_project_LODPlugin_Plugins_MLBasedLODSelector_Source_MLBasedLODSelector_Public_DataLogger_h_3079647177(TEXT("/Script/MLBasedLODSelector"),
